...
5. **Utilizar validação cruzada:**
   ...
   <div style="display: flex;">
    <img src="/img/AUC-Random_Forest.png" alt="AUC Curve" style="width: 50%; object-fit: contain;">
    <img src="/img/matriz_confusao-Random_Forest.png" alt="Matriz de Confusão" style="width: 50%; object-fit: contain;">
   </div>
